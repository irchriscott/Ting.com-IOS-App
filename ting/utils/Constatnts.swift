...
struct URLs {
    static let hostEndPoint             = "http://192.168.150.1:8000"
    static let uploadEndPoint           = "http://192.168.150.1:8000/tinguploads/"
    static let endPoint                 = "http://192.168.150.1:8000/api/v1/"
